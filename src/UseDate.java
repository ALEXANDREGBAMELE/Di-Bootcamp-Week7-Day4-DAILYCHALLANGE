...
public class UseDate {
	...
	public static void main(String[] args) {
		...
		/*
		 * 1 Which day of the week is today? Print which day of the week is
		 * today.HINT: create today as a new object using LocalDate.now()
		 * and ask today which day of the week it is.
		 */
